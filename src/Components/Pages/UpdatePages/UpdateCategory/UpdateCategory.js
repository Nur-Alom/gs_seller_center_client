...
const UpdateCategory = () => {
    ...
    useEffect(() => {
        // setPageLoading(true)
        fetch(`https://daily-bazar-95aq.onrender.com/category/${id}`)
            .then(res => res.json())
    ...
    const onSubmit = data => {
        ...
        // console.log(data);
        swal(<div>
            <h2 className='text-xl font-medium'>Are You Sure to Update This Category?</h2>
            ...
            .then((willDelete) => {
                if (admin && willDelete) {
                    setInfoLoading(true);
                    fetch(`https://daily-bazar-95aq.onrender.com/up-category/${_id}`, {
                        method: 'PUT',
                        headers: {
