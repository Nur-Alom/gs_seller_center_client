        ...
        <div className='w-64 shadow'>
            ...
            <div className=''>
                <ul className=''>
                    ...
                    <li className=''>
                        <NavLink className="px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-green-700 dark:hover:text-gray-200 text-gray-500 dark:text-gray-100" to="/">
                    ...
                    <li className=''>
                        <NavLink className="px-6 py-4 inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-green-700 dark:hover:text-gray-200 text-gray-500 dark:text-gray-100" to="/">
                            ...
                            <span className='px-3'>Out Staff</span>
                        </NavLink>
                    </li>
                    <li className=''>
