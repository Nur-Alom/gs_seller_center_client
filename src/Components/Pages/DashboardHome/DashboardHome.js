                    ...
                    <div className='grid gap-4 mb-8 md:grid-cols-2 xl:grid-cols-4'>
                        <div class="p-4 flex items-center border border-gray-200 dark:border-gray-800 w-full rounded-lg">
                            <div class="flex items-center justify-center p-3 rounded-full h-12 w-12 text-center mr-4 text-lg text-orange-600 dark:text-orange-100 bg-orange-100 dark:bg-orange-500">
                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                                </svg>
                            </div>
                            <div>
                                ...
                                <p class="text-2xl font-bold leading-none text-gray-600 dark:text-gray-200">292</p>
                            </div>
                        </div>
                        <div class="p-4 flex items-center border border-gray-200 dark:border-gray-800 w-full rounded-lg">
                            ...
                            <div>
                                <p class="mb-1 text-sm font-medium text-gray-600 dark:text-gray-400">
                                    ...
                                    <span class="text-red-400 text-sm font-semibold">(20854.60)</span>
                                </p>
                                <p class="text-2xl font-bold leading-none text-gray-600 dark:text-gray-200">90</p>
                            </div>
                        </div>
                        <div class="p-4 flex items-center border border-gray-200 dark:border-gray-800 w-full rounded-lg">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold leading-none text-gray-600 dark:text-gray-200">80</p>
                            </div>
                        </div>
                        <div class="p-4 flex items-center border border-gray-200 dark:border-gray-800 w-full rounded-lg">
                            <div class="flex items-center justify-center p-3 rounded-full h-12 w-12 text-center mr-4 text-lg text-green-600 dark:text-green-100 bg-green-100 dark:bg-green-500">
                                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12"></polyline>
                                </svg>
                            </div>
                            <div>
                                <p class="mb-1 text-sm font-medium text-gray-600 dark:text-gray-400">
                                ...
                                <p class="text-2xl font-bold leading-none text-gray-600 dark:text-gray-200">101</p>
                            </div>
                        </div>
                    </div>
                </div>
