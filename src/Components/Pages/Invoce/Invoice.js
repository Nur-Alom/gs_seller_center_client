        ...
        <div>
            <div className='display-invoice px-6 mx-auto'>
                        ...
                        {loading ?
                            ...
                            <div className=''>
                                <div id='invoice' className=''>
                                    ...
                                    <div className='flex flex-col md:flex-row justify-between px-7 py-8 bg-gray-100 rounded-lg'>
                                        <span>
                ...
                {!loading && <div className='mt-6 mb-5 text-right'>
                    <button className='text-sm font-sans inline-flex items-center justify-between bg-green-600 hover:bg-green-800 px-3 py-2 rounded-md text-white gap-2' onClick={() => window.print('invoice')}>
                        PRINT INVOICE
            ...
            <div className='print-invoice py-3 md:py-6 px-4 md:px-6'>
                <div className=''>
                    <div id='invoice' className=''>
                        <div className=''>
                        ...
                        <div className='my-8 w-full overflow-hidden border border-gray-200 dark:border-gray-700 rounded-lg'>
                            <table className="w-full whitespace-no-wrap">
                                <thead className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:text-gray-400 dark:bg-gray-800">
                                    <tr className=''>
                                        <td className='px-4 py-3'>SR.</td>
