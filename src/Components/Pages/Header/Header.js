...
const Header = () => {
    ...
    // Load Staffs Info.
    useEffect(() => {
        fetch(`https://gs-seller-center-server.up.railway.app/staffs?email=${user?.email}`)
            .then(res => res.json())
            .then(data => {
